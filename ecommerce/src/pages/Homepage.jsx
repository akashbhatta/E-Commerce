...
function Homepage() {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <div className="relative bg-linear-to-br from-indigo-900 via-purple-900 to-pink-800 min-h-screen flex items-center overflow-hidden">
            ...
            <div className="text-white">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link to="/products" className="group">
                  <button className="bg-linear-to-r from-yellow-400 to-orange-500 text-black font-bold py-4 px-8 rounded-full text-lg transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                    Explore Products
                  </button>
                </Link>
            ...
            <div className="relative">
              <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-8 border border-white/20">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="bg-linear-to-br from-green-500 to-teal-600 rounded-2xl p-6 text-white">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              <div key={category.name} className="group cursor-pointer">
                <div className={`bg-linear-to-br ${category.color} rounded-2xl p-8 text-center text-white transition-all duration-300 group-hover:scale-105 group-hover:shadow-2xl`}>
